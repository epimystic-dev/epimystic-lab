...
interpreter raises ``No module named elevatescan.__main__; 'elevatescan' is a
...
class PythonDashMInvocation(unittest.TestCase):
    def test_help_returns_zero(self):
        ...
        self.assertEqual(
            r.returncode,
            0,
            msg="python -m elevatescan --help must exit 0; "
    ...
    def test_version_returns_zero(self):
        ...
        self.assertEqual(
            r.returncode,
            0,
            msg="python -m elevatescan --version must exit 0; "
            "got rc={} stderr={!r}".format(r.returncode, r.stderr),
        )
        self.assertIn("elevatescan", r.stdout)

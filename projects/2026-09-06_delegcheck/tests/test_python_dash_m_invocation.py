...
interpreter raises ``No module named delegcheck.__main__; 'delegcheck' is a
...
class PythonDashMInvocation(unittest.TestCase):
    def test_help_returns_zero(self):
        ...
        self.assertEqual(
            r.returncode,
            0,
            msg="python -m delegcheck --help must exit 0; "
    ...
    def test_version_returns_zero(self):
        ...
        self.assertEqual(
            r.returncode,
            0,
            msg="python -m delegcheck --version must exit 0; "
            "got rc={} stderr={!r}".format(r.returncode, r.stderr),
        )
        self.assertIn("delegcheck", r.stdout)

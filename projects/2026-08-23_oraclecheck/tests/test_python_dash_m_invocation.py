...
interpreter raises ``No module named oraclecheck.__main__; 'oraclecheck' is a
...
class PythonDashMInvocation(unittest.TestCase):
    def test_help_returns_zero(self):
        ...
        self.assertEqual(
            r.returncode,
            0,
            msg="python -m oraclecheck --help must exit 0; "
    ...
    def test_version_returns_zero(self):
        ...
        self.assertEqual(
            r.returncode,
            0,
            msg="python -m oraclecheck --version must exit 0; "
            "got rc={} stderr={!r}".format(r.returncode, r.stderr),
        )
        self.assertIn("oraclecheck", r.stdout)
